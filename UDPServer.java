...
public class UDPServer {
    ...
    int index = 0;
    static int ctr = 0;
    static UDPServer s = new UDPServer();

    /**
     * The main() method creates the thread for the 2 clients.
     */
    public static void main(String args[]) throws SocketException, IOException {
        ...
        while (ctr < 2) {
            ...
            new UDPServerThread(serverSocket, wordselected, ctr).start();
            ctr++;
    ...
    /**
     * The select_random() method selects the random word. array. to all the
     * clients.
     *
