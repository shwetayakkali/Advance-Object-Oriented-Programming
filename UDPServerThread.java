...
public class UDPServerThread extends Thread {
    ...
    UDPServerThread(DatagramSocket serverSocket, String wordselected, int clientno) {
    ...
    public void run() {
        ...
        while (!done) {
            ...
            while (!done) {
                ...
                DatagramPacket sendguess = new DatagramPacket(guessbuf, guessbuf.length, IPAddress, port);
                try {
                ...
                DatagramPacket letterenter = new DatagramPacket(enterletter, enterletter.length, IPAddress, port);
                try {
                ...
                if (guess.length() < 1) {                                   // user can give only one character at a time.
                    if (guess.equals(wordselected)) {
                        ...
                        DatagramPacket packet1 = new DatagramPacket(buf1, buf1.length, IPAddress, port);
                        try {
                        ...
                        DatagramPacket packet2 = new DatagramPacket(buf2, buf2.length, IPAddress, port);
                        try {
                    ...
                    buf3 = ("").getBytes();
                    DatagramPacket packet3 = new DatagramPacket(buf3, buf3.length, IPAddress, port);
                    try {
                    ...
                    buf4 = ("").getBytes();
                    DatagramPacket packet4 = new DatagramPacket(buf4, buf4.length, IPAddress, port);
                    try {
                    ...
                    buf5 = ("").getBytes();
                    DatagramPacket packet5 = new DatagramPacket(buf5, buf5.length, IPAddress, port);
                    try {
                    ...
                    buf6 = ("").getBytes();
                    DatagramPacket packet6 = new DatagramPacket(buf6, buf6.length, IPAddress, port);
                    try {
                    ...
                    buf7 = ("").getBytes();
                    DatagramPacket packet7 = new DatagramPacket(buf7, buf7.length, IPAddress, port);
                    try {
                    ...
                    if (wordselected.indexOf(letter) < 0 && guesses.indexOf(letter) < 0) { // to handle the scoring for a single alphabet entered multiple times.
                        ...
                        DatagramPacket packet8 = new DatagramPacket(buf8, buf8.length, IPAddress, port);
                        try {
                        ...
                        DatagramPacket packet9 = new DatagramPacket(buf9, buf9.length, IPAddress, port);
                        try {
                    ...
                    if (guesses.indexOf(letter) < 0) {
                        try {
                            ...
                            dashes = matchLetter(wordselected, dashes, letter, IPAddress, port);                        // method call to match letter
                        ...
                        DatagramPacket packet10 = new DatagramPacket(buf10, buf10.length, IPAddress, port);
                        try {
                    ...
                    DatagramPacket packet12 = new DatagramPacket(buf12, buf12.length, IPAddress, port);
                    try {
                    ...
                    if (chances == 0) {                                                // due to incorrect guesses chances over
                        ...
                        DatagramPacket packet13 = new DatagramPacket(buf13, buf13.length, IPAddress, port);
                        try {
                        ...
                        DatagramPacket packet14 = new DatagramPacket(buf14, buf14.length, IPAddress, port);
                        try {
                        ...
                        buf15 = ("").getBytes();
                        DatagramPacket packet15 = new DatagramPacket(buf15, buf15.length, IPAddress, port);
                        try {
                        ...
                        buf16 = ("").getBytes();
                        DatagramPacket packet16 = new DatagramPacket(buf16, buf16.length, IPAddress, port);
                        try {
                    ...
                    if (wordselected.equals(dashes.toString())) {                      // word is correct if the entered letters match the actual word
                        ...
                        DatagramPacket packet17 = new DatagramPacket(buf17, buf17.length, IPAddress, port);
                        try {
                        ...
                        buf18 = ("").getBytes();
                        DatagramPacket packet18 = new DatagramPacket(buf18, buf18.length, IPAddress, port);
                        try {
        ...
        if (points_table[0] == points_table[1]) {
            ...
            buf19 = ("DRAW!").getBytes();
            DatagramPacket packet19 = new DatagramPacket(buf19, buf19.length, IPAddress, port);
            try {
            ...
            byte buf19[] = new byte[128];
            buf19 = ("winner is Player " + "0").getBytes();
            DatagramPacket packet19 = new DatagramPacket(buf19, buf19.length, IPAddress, port);
            try {
                serverSocket.send(packet19);
            } catch (IOException ex) {
            ...
            byte buf19[] = new byte[128];
            buf19 = ("winner is Player " + "1").getBytes();
            DatagramPacket packet19 = new DatagramPacket(buf19, buf19.length, IPAddress, port);
            try {
                serverSocket.send(packet19);
            } catch (IOException ex) {
    ...
    public StringBuffer matchLetter(String wordselected, StringBuffer dashes, char letter, InetAddress IPAddress, int port) throws IOException {
        ...
        DatagramPacket packet11 = new DatagramPacket(buf11, buf11.length, IPAddress, port);
        try {
