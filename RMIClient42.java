...
/**
 * RMIClient42 is the Client.
 *
 * @author Shweta Yakkali
 * @author Aishwarya Desai
 */
public class RMIClient42 extends UnicastRemoteObject {
    ...
    public RMIClient42() throws RemoteException, NotBoundException, MalformedURLException, FileNotFoundException {
        super();
    ...
    public RMIClient42(int clientid) throws RemoteException {
    ...
    public static void main(String args[]) throws NotBoundException, MalformedURLException, RemoteException, FileNotFoundException, IOException {
        ...
        RMIClient42 client = new RMIClient42();
        System.out.println("Client2  Conected \n ");
        String serverOutput;

        serverOutput = stub.counterCheck(2);
    ...
    public void clientmethod() {
        try {
            ...
            System.out.println("Final score of Player 2  is:" + "  " + score);

            int ctr = stub.putscore(score, 2);
            System.out.println("waiting for other players to finish");

            while (ctr != 4) {
                //System.out.println(ctr+"   ctr value in client2");
                ctr = stub.putscore(score, 2);
            }
            if (ctr == 4) {
